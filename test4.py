    ...
    if not is_tutorial:
        ...
        while slide < 5:
            ...
            if(slide==0):
                ...
                displayText(300,210,"Click the mouse when you are ready to proceed",BLACK) 
            elif(slide==1):
                ...
                DISPLAYSURF.blit(pic,(0,0))
                displayText(300,100,"Put your mouse over the circle and follow the",BLACK)
                displayText(300,140,"purple path it creates until you reach the end",BLACK)
                Circ.draw()
            pygame.display.update()
    Backgrd.switch_mode()
